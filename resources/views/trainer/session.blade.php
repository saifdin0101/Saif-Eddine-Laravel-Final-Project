            ...
            <div class="w-full mt-[10rem] relative">
                ...
                <div class=" mt-14 py-5 flex justify-center items-center flex-col gap-5">
                    @forelse ($sessions as $session)
                        <div class="h-[25rem] w-[55rem] overflow-hidden rounded-3xl relative">
                            ...
                            <div
                                class="h-[17rem] w-[15rem] absolute top-10 right-5 rounded-xl flex justify-center items-center flex-col gap-5 bg-white/30 backdrop-blur-lg shadow-lg">
                    ...
                    @empty
                        <div>No Session Been Added Yet !!! -> Be The first To Create A session</div>
                    @endforelse
