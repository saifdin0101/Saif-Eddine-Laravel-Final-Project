        ...
        <div class="100vw flex">
            ...
            <div class="w-full text-blue-50 relative mt-[10rem]">
                ...
                <div class=" flex justify-center items-center mt-[5rem] flex-wrap gap-5 ">
                    ...
                    <div class="exercise-card bg-[#004f5f] text-white rounded-lg shadow-2xl overflow-hidden transform transition duration-300 ease-in-out hover:scale-105 hover:shadow-3xl">
                        <!-- Image -->
                        <div class="relative">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <!-- Premium Badge -->
                            @if($exercice->premium)
                                <div class="absolute top-4 right-4 bg-[#00e0d4] text-[#004f5f] py-1 px-4 rounded-full text-xs font-semibold shadow-lg">
                                    Premium
                                </div>
                            @endif
                        </div>
