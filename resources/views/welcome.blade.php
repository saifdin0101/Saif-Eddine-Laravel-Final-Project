...
@section('content')
    ...
    <div class=" h-[100vh] parentDiv flex flex-col ">
        <div class="fixed  top-3 z-[999999999999999999999] right-3">
            <button id="darkModeToggle"
                class="flex items-center  text-[#2efbfa] rounded-full px-3 py-3 text-base font-medium h-[50px] justify-center transition-colors duration-200"
                :class="{ 'justify-center': !expanded }">
                <!-- Dark Mode Icon (Half Moon) -->
                <svg id="darkIcon" xmlns="http://www.w3.org/2000/svg"
                    class="h-7 w-7 flex-shrink-0 " fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                ...
                <svg id="lightIcon" xmlns="http://www.w3.org/2000/svg"
                    class="h-7 w-7 flex-shrink-0  hidden" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class=" relative flex-col   h-[80vh] flex justify-center items-center">
                <div data-aos-once="false" data-aos-delay="200" data-aos="fade-down"
                    ...
                    <div class="flex     awser flex-col gap-5 justify-center items-center font-bold">
                        <p data-aos-once="false" data-aos-delay="300" data-aos="fade-right"
                            class="text-2xl   cursor-default ">Push Your Limits, Challenge Yourself, and Achieve Greatness
                        </p>
                        <p data-aos-once="false" data-aos-delay="400" data-aos="fade-right"
                            class="text-6xl   cursor-default ">Unleash Your Full Potential Today</p>
                        <p data-aos-once="false" data-aos-delay="500" data-aos="fade-right"
                            class="text-3xl   cursor-default ">Train Hard, Stay Strong, Never Quit</p>
                    </div>
                    <div class="flex gap-5">
                        <a href="#plans"
                            class=" font-semibold flex justify-center items-center text-xl btn  w-[14rem] h-[3.5rem] border-black border-2">View
                            Our Plans</a>
                        <a href="#news"
                            class=" font-semibold flex justify-center items-center text-xl btn  w-[14rem] h-[3.5rem] border-black border-2">Check
                            The
                            News</a>
                    </div>
                </div>
    ...
    <div id="news" class="h-[110vh]  w-full flex justify-center items-center">
        <div class=" flex flex-col gap-5 h-[100vh] w-[80%]">
            <div class="h-[40%]  flex gap-5">
                ...
                <div data-aos-once="false" data-aos-delay="500" data-aos="fade-up"
                    class=" h-full w-[40rem] flex shadow-[4px_4px_8px_0px_rgba(0,0,0,0.25)]">
                    ...
                    <div class="flex justify-center w-[50%] bg-white  flex-col gap-10">
                        ...
                        <div class="ml-5 uppercase font-bold text-xl text-black">New boxing machines available for intense
                            workouts.</div>
                        <div class="text-sm ml-5 text-[#585b63]">New Boxing Machines Available For Intense, Efficient
                            Workouts. Improve Strength And Endurance With Advanced Equipment.</div>
                    </div>

                </div>
            </div>
            <div class="h-[60%]  flex gap-[2.1rem]  relative ">
                <div data-aos-once="false" data-aos-delay="600" data-aos="fade-up"
                    class="w-[660px]  h-full overflow-hidden">
                    <div
                        class="w-full relative h-full object-cover img3 transition-transform duration-500 hover:scale-110">
                    </div>
                    <div class="absolute bottom-5 left-5 uppercase font-bold text-3xl text-[#ffffff] ">Outdoor areas for
                        training <br> and relaxation</div>
                </div>
                <div data-aos-once="false" data-aos-delay="700" data-aos="fade-up"
                    class=" h-[50%] w-[29.5rem] absolute bottom-0 right-0  flex  shadow-[4px_4px_8px_0px_rgba(0,0,0,0.25)] ">
                    <div class="h-full w-[50%]  flex flex-col gap-3 bg-white ">
                        ...
                        <div class="ml-5  uppercase font-bold text-xl text-black">Inspiring dedication and passion daily
                        </div>
                        <div class="ml-5 text-sm  text-[#585b63]">Meet Our Coach Of The Week, Leading With Expertise,
                            Passion, And Commitment To Fitness.</div>
                    </div>
                    <div class="h-full w-[50%]  overflow-hidden">
    ...
    <div class="h-[80vh] flex justify-center items-center">
        ...
        <div class="flex flex-col gap-10 absolute justify-center items-center">
            <div data-aos-once="false" data-aos-delay="200" data-aos="fade-left" class="font-thin text-5xl text-white">
                Check Our New Trainers</div>
            <a data-aos-once="false" data-aos-delay="300" data-aos="fade-right" href="{{ route('login') }}"
                class="btn flex justify-center items-center w-[15rem]">Sign Up</a>
        </div>
    </div>
    ...
    <div class="flex flex-wrap justify-center gap-8 p-10 bg-gradient-to-br  max-h-[60rem]">
        ...
        <div data-aos-once="false" data-aos-delay="200" data-aos="fade-down"
            ...
            <div class="relative p-8">
                <h3 class="text-3xl font-extrabold text-[#00e0d4] group-hover:text-white transition duration-300">Basic
                    Plan
                </h3>
    ...
    <div id="contact" class="w-full h-[60vh]  flex justify-center items-center flex-col gap-10">
        ...
        <div class="flex  justify-center items-center flex-col gap-5 w-full h-[80%] ">
            ...
            <textarea data-aos-once="false" data-aos-delay="600" data-aos="fade-up" placeholder="Subject..."
                class="border-[#00e0d4] pl-5 border-2 rounded-lg" name="" id="" cols="128" rows="10"></textarea>
    ...
    <footer class="w-full bg-black h-[12rem] flex flex-col">
        <div class="w-full h-[40%] flex justify-around items-center text-white">
            <a data-aos-once="false" data-aos-delay="600" data-aos="zoom-in" class="spacee gradiant text-2xl text-white"
                href="/">WorkOut-Now</a>
            <div class="flex gap-5">
                <div data-aos-once="false" data-aos-delay="200" data-aos="fade-up"
                    class="p-1 px-2 flex justify-center items-center text-3xl rounded-full text-[#00e0d4]"><i
                        class="bi bi-facebook"></i></div>
                <div data-aos-once="false" data-aos-delay="400" data-aos="fade-up"
                    class="p-1 px-2 flex justify-center items-center text-3xl rounded-full text-[#00e0d4]"><i
                        class="bi bi-instagram"></i></div>
                <div data-aos-once="false" data-aos-delay="600" data-aos="fade-up"
                    class="p-1 px-2 flex justify-center items-center text-3xl rounded-full text-[#00e0d4]"><i
                        class="bi bi-twitter"></i></div>
                <div data-aos-once="false" data-aos-delay="800" data-aos="fade-up"
                    class="p-1 px-2 flex justify-center items-center text-3xl rounded-full text-[#00e0d4]"><i
